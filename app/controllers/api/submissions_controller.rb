...
module Api
  class SubmissionsController < ApiBaseController
    ...
    def show
      ...
      if @submission.audit_trail_attachment.blank? && submitters.select(&:required?).all?(&:completed_at?)
      ...
      permitted_attrs = [
        ...
        :require_phone_2fa, :require_email_2fa, :expire_at, :name,
        {
          ...
          submitters: [[:send_email, :send_sms, :completed_redirect_url, :uuid, :name, :email, :role,
                        ...
                        :require_phone_2fa, :require_email_2fa, :order, :index, :invite_by, :required,
